...
import { getTagFromLine } from "./index.js";
...
describe('getTagFromLine', () => {
    ...
    test('get "TheWelcome" from "<TheWelcome href="https://x.com/vuejs" target="_blank" rel="noopener">@vuejs</TheWelcome>', () => {
        expect(getTagFromLine('<TheWelcome href="https://x.com/vuejs" target="_blank" rel="noopener">@vuejs</TheWelcome>')).to.eql(['TheWelcome']);
    });
    test('get "TheWelcome" from "<TheWelcome href="javascript:void(0)" @click="(someVar: SomeType<ThisNot>) => openReadmeInEditor""', () => {
        expect(getTagFromLine('<TheWelcome href="javascript:void(0)" @click="(someVar: SomeType<ThisNot>) => openReadmeInEditor"')).to.eql(['TheWelcome']);
    });
